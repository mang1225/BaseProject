...
public interface HttpApi {
   ...
   */
  @GET("data/{category}/{pageSize}/{page}") Observable<HttpResult<List<GankEntity>>> getCategoryData(@Path("category") String category, @Path("pageSize") int pageSize, @Path("page") int page);
}
