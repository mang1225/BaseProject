...
public class MainActivity extends BaseActivity {
  ...
  @BindView(R.id.bt_loading) Button bt_loading;
  @BindView(R.id.bt_success) Button bt_success;
  @BindView(R.id.bt_fail) Button bt_fail;
  ...
  @OnClick({ R.id.bt_loading, R.id.bt_success, R.id.bt_fail }) public void onViewClicked(View view) {
    switch (view.getId()) {
